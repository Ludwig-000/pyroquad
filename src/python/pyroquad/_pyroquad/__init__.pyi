...
__all__ = [
    ...
    "get_mouse_buttons_released",
    "get_mouse_delta_position",
    "get_mouse_position",
    "get_mouse_position_local",
    "get_mouse_wheel",
    "get_screen_data",
    "get_text_center",
    "is_quit_requested",
...
class FileData:
    ...
    def bytes(self) -> builtins.list[builtins.int]:
        ...
        """
    @bytes.setter
    def bytes(self, value: typing.Sequence[builtins.int]) -> None:
        r"""
        These are the raw bytes of a file.
        They likely do not need to be edited manually.
        """
    ...
    def to_Image(self) -> Image:
        ...
        """
    def to_Texture2D(self) -> Texture2D:
        r"""
...
@typing.final
class Future:
    def result(self) -> typing.Optional[typing.Literal['EmptyFuture']]: ...
    def result_nowait(self) -> typing.Literal['EmptyFuture']: ...
    def result_nowait_timeout(self, timeout: builtins.float = 1.7976931348623157e+308) -> typing.Literal['Timeout', 'EmptyFuture']:
        r"""
        waits for the result, with timeout in seconds.
        """
...
class Vec2:
    ...
    def move_towards(self, rhs: Vec2, d: builtins.float) -> Vec2:
        ...
        """
    def to_angle(self) -> builtins.float:
        r"""
...
def draw_affine_parallelogram(offset: Vec3, e1: Vec3, e2: Vec3, texture: typing.Optional[Texture2D], color: Color) -> None: ...
...
def draw_multiline_text(text: builtins.str, x: builtins.float, y: builtins.float, font_size: builtins.int = 20, color: Color = ..., font: typing.Optional[Font] = None, rotation: builtins.float = 0.0, line_distance_factor: typing.Optional[builtins.float] = None, font_scale: builtins.float = 1.0, font_scale_aspect: builtins.float = 1.0) -> None: ...
